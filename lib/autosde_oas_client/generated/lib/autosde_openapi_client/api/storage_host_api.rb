...
module OpenapiClient
  class StorageHostApi
    ...
    def storage_hosts_pk_put_with_http_info(pk, storage_host_update, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(storage_host_update) 

      # return_type
      return_type = opts[:return_type] || 'StorageHost' 
    ...
    def storage_hosts_post_with_http_info(storage_host_create, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'StorageHostResponse' 
