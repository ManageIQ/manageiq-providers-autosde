class ManageIQ::Providers::Autosde::BlockStorageManager < ManageIQ::Providers::BlockStorageManager
  ...
  def self.raw_connect(host)
    ManageIQ::Providers::Autosde::BlockStorageManager::AutosdeClient.new(host: host)
  end
