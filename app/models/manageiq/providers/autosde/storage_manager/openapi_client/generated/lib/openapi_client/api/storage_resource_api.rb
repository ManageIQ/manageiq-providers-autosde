...
module OpenapiClient
  class StorageResourceApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<StorageResource>, Integer, Hash)>] Array<StorageResource> data, response status code and response headers
    ...
    # @param pk [Integer] 
    # @param storage_resource [StorageResource] 
    # @param [Hash] opts the optional parameters
    # @return [Array<StorageResource>]
    def storage_resources_pk_put(pk, storage_resource, opts = {})
      data, _status_code, _headers = storage_resources_pk_put_with_http_info(pk, storage_resource, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<StorageResource>, Integer, Hash)>] Array<StorageResource> data, response status code and response headers
    def storage_resources_pk_put_with_http_info(pk, storage_resource, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'storage_resource' is set
      if @api_client.config.client_side_validation && storage_resource.nil?
        fail ArgumentError, "Missing the required parameter 'storage_resource' when calling StorageResourceApi.storage_resources_pk_put"
      end
      # resource path
      local_var_path = '/storage-resources/{pk}'.sub('{' + 'pk' + '}', CGI.escape(pk.to_s))
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(storage_resource) 
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<StorageResource>]
    def storage_resources_post(storage_resource, opts = {})
      data, _status_code, _headers = storage_resources_post_with_http_info(storage_resource, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<StorageResource>, Integer, Hash)>] Array<StorageResource> data, response status code and response headers
    def storage_resources_post_with_http_info(storage_resource, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StorageResourceApi.storage_resources_post ...'
      end
      # verify the required parameter 'storage_resource' is set
      if @api_client.config.client_side_validation && storage_resource.nil?
        fail ArgumentError, "Missing the required parameter 'storage_resource' when calling StorageResourceApi.storage_resources_post"
      end
      # resource path
      local_var_path = '/storage-resources/'
